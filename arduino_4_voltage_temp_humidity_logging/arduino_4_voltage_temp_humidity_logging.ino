/*
arduino_4_voltage_temp_humidity_logging
...
Temperature and Humidity measurement uses a DHT22 sensor and
software as described in https://learn.adafruit.com/dht

Measure voltage, temperature and humidity and record them with a timestamp in a CSV file on
the SD card in the Data Logging Shield
*/

// Includes and variables for DHT22
#include "DHT.h"
...
void logDataToFile() {
  ...
  // This takes about 250 milliseconds
  // Sensor readings may also be up to 2 seconds 'old' (its a very slow sensor)
  float humidity = dht.readHumidity();
  // Read temperature as Celsius (or pass true for Fahrenheit)
  ...
  if(arduinoPowerCurrentTime - arduinoPowerPreviousTime >= arduinoPowerLogInterval or logMessage != "") {
    ...
    addFieldToDataString(String(humidity, 3));
    addFieldToDataString(String(temperature, 3));
